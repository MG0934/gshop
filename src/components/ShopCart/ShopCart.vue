<template>
  <div>
    <div class="shopcart">
      <div class="content" @click.stop="checkShow">
        <div class="content-left">
          ...
          <div class="price" :class="{highlight:totalCount>0}" v-if="totalPrice">￥{{totalPrice}}</div>
          <div class="desc" v-if="totalPrice">另需配送费￥{{shopInfo.deliveryPrice}} 元</div>
        </div>
      ...
      <transition name="move">
        <div class="shopcart-list" v-if="show&&isShow">
