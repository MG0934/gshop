<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="shopInfo.supports" @click="toggleShopSupport">
    ...
    <transition name="fade">
      ...
      <div class="activity-sheet" v-show="shopSupport">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close">
            <span class="iconfont icon-close" @click="toggleShopSupport"></span>
          </div>
        </div>
...
export default {
  ...
  methods: {
    toggleShopSupport() {
      this.shopSupport = !this.shopSupport;
    },
    toggleShopShow() {
